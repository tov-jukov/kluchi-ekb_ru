    ...
    <div id="page">
        ...
        <div class="steps">
            <div class="wrapper">
                ...
                <p>
                    Любая зависимость требует обязательного вмешательства квалифицированных специалистов. Ведь самостоятельно справиться со своим недугом сложно. Реабилитационный центр Ключи предоставляет курс медикаментозного лечения и последующей реабилитации.
                </p>
                <div class="items">
